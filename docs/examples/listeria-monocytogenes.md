...
8.  Add the position of the detected phage to the invalid-positions.txt file.  The final file should like this:  
    ...
    For more information on the formatting of the invalid-positions.bed file please refer to: **http://snvphyl.readthedocs.org/en/latest/user/usage/#invalid-positions-masking-file** 

9.  Save the invalid-positions.bed file to your hard drive.

We have now generated a properly formatted invalid-posiitons.bed file, showing a phage region discovered within our reference genome.  The positions within this region will be excluded from the downstream SNVPhyl analysis.    
