...
You can log into this virtual environment by using the username vagrant and the password vagrant. Alternatively, you can SSH into this virtual environment by running ssh -p2222 vagrant@localhost and using the password vagrant.  This account has sudo access.  The Galaxy log files are located at /opt/galaxy/galaxy/paster.log.
